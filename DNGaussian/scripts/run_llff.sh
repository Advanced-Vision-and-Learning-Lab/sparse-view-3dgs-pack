...
python DNGaussian/train_llff.py  -s $dataset --model_path $workspace -r 8 --eval --n_sparse 3  --rand_pcd --iterations 6000 --lambda_dssim 0.2 \
...
python DNGaussian/spiral.py -s $dataset --model_path $workspace -r 8 --near 10 
