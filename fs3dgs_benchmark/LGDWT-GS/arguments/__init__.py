...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.eval = False
        self.n_views = 0  # Number of views to use for training (0 = use all views)
        self.point_cloud_type = "dense"  # Point cloud type: "dense", "triangulated", or "sparse"
